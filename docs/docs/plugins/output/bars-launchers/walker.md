...
- [waybar](./waybar.md) — status bar styling that shares the `@define-color` GTK CSS pattern.
- [wofi](./wofi.md) — alternative GTK-based launcher.
- [fuzzel](./fuzzel.md) — non-GTK launcher for users who prefer a simpler config.
