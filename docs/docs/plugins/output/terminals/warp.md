...
- [alacritty](./alacritty.md), [ghostty](./ghostty.md), [kitty](./kitty.md), [wezterm](./wezterm.md) — other modern terminals.
- [tmux](../special/tmux.md) — multiplexer status-bar styling for users who run tmux inside Warp.
