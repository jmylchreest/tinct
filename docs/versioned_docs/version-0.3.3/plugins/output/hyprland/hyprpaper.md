...
- [hyprlock](./hyprlock.md) — lock screen styling for Hyprland; shares the `$tinct_wallpaper` path.
- [wbg](../special/wbg.md) — alternative wallpaper setter for non-Hyprland Wayland sessions.
