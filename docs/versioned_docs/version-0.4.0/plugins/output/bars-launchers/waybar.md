...
- [hyprland](../hyprland/hyprland.md) — compositor colour exports often configured alongside Waybar.
- [hyprlock](../hyprland/hyprlock.md) — lock screen styling for Hyprland users.
- [dunst](./dunst.md) — notification daemon, commonly themed with Waybar.
