...
- [tmux](../special/tmux.md) — terminal multiplexer status line, complementary to Neovim sessions.
- [zellij](./zellij.md) — alternative multiplexer with native theme support.
- [ghostty](../terminals/ghostty.md) / [kitty](../terminals/kitty.md) / [alacritty](../terminals/alacritty.md) — terminal emulator themes so the surrounding shell matches.
