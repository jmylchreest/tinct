...
plugin:
  ...
  generated_files:
    - tinct-a/gnome-shell/gnome-shell.css
    - tinct-b/gnome-shell/gnome-shell.css
  reload:
    method: ipc
    command: >-
      gsettings set org.gnome.shell.extensions.user-theme name tinct-a (or D-Bus
      Main.loadTheme())
...
- [gtk3](./gtk3.md), [gtk4](./gtk4.md), [libadwaita](./libadwaita.md) — theme the applications running inside GNOME Shell.
- [dunst](../bars-launchers/dunst.md) — alternative notification daemon for users who replace GNOME's notification stack.
