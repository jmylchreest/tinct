...
plugin:
  ...
  generated_files:
    - TinctDark.colorscheme
    - TinctLight.colorscheme
  reload:
    method: none
...
- [kde-plasma](../desktop/kde-plasma.md) — KDE Plasma desktop colour scheme; pair with Konsole for a consistent KDE look.
- [qt5](../desktop/qt5.md), [qt6](../desktop/qt6.md) — Qt application palettes that align with Konsole's colours.
