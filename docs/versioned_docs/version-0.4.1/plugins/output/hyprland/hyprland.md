...
- [hyprlock](./hyprlock.md) — lock screen styling for Hyprland.
- [hyprpaper](./hyprpaper.md) — wallpaper manager for Hyprland.
- [waybar](../bars-launchers/waybar.md) — status bar commonly paired with Hyprland.
- [dunst](../bars-launchers/dunst.md) — notification daemon styling.
