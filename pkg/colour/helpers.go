...
// PaletteHelper provides utilities for output plugins to access palette colors.
...
// NewPaletteHelper creates a helper for the given theme type and color map.
...
func (ph *PaletteHelper) ThemeTypeString() string {
	return ph.themeType.String()
}

// FindClosestANSIColor is implemented in ansi.go
