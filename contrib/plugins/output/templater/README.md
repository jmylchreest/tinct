...
- Generate documentation with colour swatches
...
templates:
  ...
  # Example 4: Generate documentation with colour swatches
  - name: "theme-docs"
    description: "Theme documentation with colour swatches"
    template_path: "~/.config/tinct/templates/theme-docs.md.tmpl"
    output_path: "~/projects/myapp/docs/THEME.md"
    enabled: true

  # Example 5: Generate i3 colour configuration
  - name: "i3-colours"
    description: "i3 window manager colour configuration"
    template_path: "~/.config/tinct/templates/i3-colours.tmpl"
    output_path: "~/.config/i3/colours"
    enabled: true
...
:root {
  ...
  /* Muted variants */
  --colour-background-muted: {{ (get . "backgroundMuted").Hex }};
  --colour-foreground-muted: {{ (get . "foregroundMuted").Hex }};
  
  /* Accent colours */
  {{ if has . "accent1" -}}
  --colour-accent-1: {{ (get . "accent1").Hex }};
  --colour-accent-1-rgb: {{ (get . "accent1").R }}, {{ (get . "accent1").G }}, {{ (get . "accent1").B }};
  {{ end -}}
  
  {{ if has . "accent2" -}}
  --colour-accent-2: {{ (get . "accent2").Hex }};
  {{ end -}}
  
  {{ if has . "accent3" -}}
  --colour-accent-3: {{ (get . "accent3").Hex }};
  {{ end -}}
  ...
  {{ end -}}
  {{ if has . "warning" -}}
  --colour-warning: {{ (get . "warning").Hex }};
  {{ end -}}
  {{ if has . "success" -}}
  --colour-success: {{ (get . "success").Hex }};
  {{ end -}}
  {{ if has . "info" -}}
  --colour-info: {{ (get . "info").Hex }};
  {{ end -}}
...
### Example 3: i3 Colours (`i3-colours.tmpl`)

```i3
# i3 colour configuration - Generated by Tinct
# Theme: {{ .ThemeType }}
...
type ThemeData struct {
    PaletteHelper *PaletteHelper  // Access to all colours and functions
    WallpaperPath string           // Path to source wallpaper (if any)
    ThemeName     string           // Theme name (empty for templater)
}
```

Access colours using the helper methods:
- `get . "roleName"` - Get colour by role
