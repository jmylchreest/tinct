...
- [swayosd](../../../../internal/plugin/output/swayosd/README.md) — alternative on-screen-display server with a different theming model.
- [dunst](../../../../internal/plugin/output/dunst/README.md) — notification daemon companion.
