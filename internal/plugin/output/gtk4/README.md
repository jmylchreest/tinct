...
plugin:
  ...
  generated_files: [tinct-gtk4.css]
  reload:
    method: none
...
For libadwaita / modern GNOME apps, use the [`libadwaita`](../libadwaita/README.md) plugin instead — it writes a different file in the same directory.
...
- [libadwaita](../libadwaita/README.md) — companion plugin for libadwaita apps; writes a different file in the same `~/.config/gtk-4.0/` directory.
