...
plugin:
  ...
  generated_files: [tinct-palette.conf, tinct.conf]
  reload:
    method: ipc
...
- [alacritty](../alacritty/README.md), [ghostty](../ghostty/README.md), [kitty](../kitty/README.md), [warp](../warp/README.md), [wezterm](../wezterm/README.md) — the terminal you're running tmux inside.
- [neovim](../neovim/README.md) — pair the multiplexer styling with an editor theme that uses the same palette.
