...
plugin:
  ...
  generated_files: [tinct-colours.kdl, tinct.kdl]
  reload:
    method: none
...
- [waybar](../waybar/README.md) — status bar commonly paired with niri.
- [fuzzel](../fuzzel/README.md) — application launcher commonly paired with niri.
- [swayosd](../swayosd/README.md) — on-screen display for volume/brightness.
- [hyprland](../hyprland/README.md) — the other tiling Wayland compositor plugin.
