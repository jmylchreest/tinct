...
- [neovim](../neovim/README.md) — companion theme for the editor often run alongside btop.
- [tmux](../tmux/README.md) — tmux colours for users running btop inside a tmux pane.
