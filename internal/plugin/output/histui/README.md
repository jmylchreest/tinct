...
plugin:
  ...
  generated_files: [tinct-colors.css]
  reload:
    method: none
...
`@define-color` only takes effect inside the stylesheet that loaded it. tinct-colors.css is loaded by histui's theme.css; other libadwaita apps are unaffected. Use the [gtk4](../gtk4/README.md) or [libadwaita](../libadwaita/README.md) plugins to theme those.
...
- [libadwaita](../libadwaita/README.md) — system-wide libadwaita colour overrides.
- [gtk4](../gtk4/README.md) — GTK4 application theming.
- [dunst](../dunst/README.md) — alternative notification daemon for X11/Wayland users not on histui.
