...
- [neovim](../neovim/README.md) — editor theming for users who pair Yazi with Neovim as a file manager workflow.
- [ghostty](../ghostty/README.md), [kitty](../kitty/README.md), [wezterm](../wezterm/README.md) — terminal themes for the host terminal Yazi runs inside.
