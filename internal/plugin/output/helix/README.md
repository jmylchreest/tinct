...
plugin:
  ...
  generated_files: [tinct-palette.toml, tinct.toml]
  reload:
    method: none
...
- [neovim](../neovim/README.md) — the other modal editor target. Different theme format but the same colour-role vocabulary.
- [ghostty](../ghostty/README.md), [wezterm](../wezterm/README.md), [kitty](../kitty/README.md) — pair the editor palette with a matching terminal scheme.
