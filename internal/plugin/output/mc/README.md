...
- [tmux](../tmux/README.md) — multiplexer theming for the surrounding shell.
- [neovim](../neovim/README.md) — external editor for users who prefer it over `mcedit`.
- [ghostty](../ghostty/README.md) / [kitty](../kitty/README.md) — terminal emulator themes so MC's surroundings match.
