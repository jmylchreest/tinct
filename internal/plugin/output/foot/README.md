...
plugin:
  ...
  generated_files: [tinct-colors.ini, tinct.ini]
  reload:
    method: signal
...
- [alacritty](../alacritty/README.md), [ghostty](../ghostty/README.md), [kitty](../kitty/README.md), [wezterm](../wezterm/README.md) — other GPU-accelerated terminals.
- [fuzzel](../fuzzel/README.md) — Wayland launcher from the same author; pairs naturally with foot.
- [tmux](../tmux/README.md) — match the terminal palette with your multiplexer status bar.
