...
plugin:
  ...
  generated_files: [tinct-colors, style.css]
  reload:
    method: none
...
- [walker](../walker/README.md) — alternative Wayland launcher with similar GTK CSS theming.
- [fuzzel](../fuzzel/README.md) — non-GTK launcher for users who prefer a single-file config.
- [rofi](../rofi/README.md) — X11/XWayland launcher with its own colour file format.
